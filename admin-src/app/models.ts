...
export interface CmsItem { id: number; display: string; fields: Record<string, any>; cells: Record<string, string>; }
...
export interface DashboardResponse { resources: ResourceMeta[]; summary: { pages: number; activePages: number; languages: number; media: number; newEnquiries: number; }; recentEnquiries: CmsItem[]; }
