...
WSGI_APPLICATION = "vartec_cms.wsgi.application"
ASGI_APPLICATION = "vartec_cms.asgi.application"
...
DEFAULT_FROM_EMAIL = os.environ.get("DEFAULT_FROM_EMAIL", "website@vartec.global")
